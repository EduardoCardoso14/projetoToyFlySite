                    ...
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                ...
                                while ($linha = $result->fetch_array()) {
                                ?>
                                    <h1 class="m-0">Produtos - <?= $linha['contador'] ?></h1>
                                <?php
                                }
                                ?>
                                <h1 class="m-0">
                            ...
                            <div class="col-sm-3">
                                <hr>
                                <form action="./cad_produto.php">
                                    <button type="submit" class="btn btn-block btn-default btn-lg">Cadastrar Novo Produto</button>
                                </form>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="card">
                                        ...
                                        <ul class="users-list clearfix">
                                            ...
                                            ?>
                                                <li>
                                                    ...
                                                    <a class="users-list-name" href="#"><?= $linha['preco'] ?></a>
                                                    <span class="users-list-date"><?= $linha['idade'] ?></span>
                                                    <a href="./deletar_product.php?id=<?= $linha['id'] ?>">
                                                        <img src="https://cdn-icons-png.flaticon.com/512/5028/5028066.png" alt="User Image" style="width: 40px">
                                                    </a>
                                                    <a href="./product_edit.php?id=<?= $linha['id'] ?>">
                                    ...
                                    <div class="card-footer text-center">
                                        <a href="javascript:">Ver todos os produtos</a>
                                    </div>
                                    <!-- /.card-footer -->
                                </div>
                                <!--/.card -->
                            ...
                            ?>
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Produtos encontrados</h3>
                                        ...
                                        <div class="card-body p-0">
                                            <ul class="users-list clearfix">
                                                ...
                                                $result = $produtinho->buscar_um_produto($search);
                                                while ($linha = $result->fetch_array()) {
                                                ?>
                                                    <li>
                                                        <img src="<?= $linha['imagem'] ?>" alt="User Image">
                                                        <a class="users-list-name" href="#"><?= $linha['nome'] ?></a>
                                                        <span class="users-list-date"><?= $linha['preco'] ?></span>
                                                        <span class="users-list-date"><?= $linha['idade'] ?></span>
                                                        <a href="./deletar_product.php?id=<?= $linha['id'] ?>">
                                                            <img src="https://cdn-icons-png.flaticon.com/512/5028/5028066.png" alt="User Image" style="width: 40px">
                                                        </a>
