...
if (isset($id)) {
    ...
    $result = $produtinho->pegar_produto($idp);
    unset($_SESSION['idp']);
} else {
    echo "<hr>";
                                        ...
                                        <div class="tab-pane" id="settings">
                                            <form class="form-horizontal" method="post" action="edit_cad_product.php">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="nome" class="form-control" id="inputName" placeholder="Nome" value="<?= $linha['nome'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputEmail" class="col-sm-2 col-form-label">Descricao</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="descricao" class="form-control" id="inputEmail" placeholder="Descrição" value="<?= $linha['descricao'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputEmail" class="col-sm-2 col-form-label">Imagem</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="imagem" class="form-control" id="inputEmail" placeholder="Imagem (LINK)" value="<?= $linha['imagem'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputName2" class="col-sm-2 col-form-label">Preço</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="preco" class="form-control" id="inputName2" placeholder="Preço" value="<?= $linha['preco'] ?>">
                                                    </div>
